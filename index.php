...
<nav id="top" class="navbar navbar-expand-lg navbar-dark py-4 sticky-lg-top" style="background-color:<?=$result_info_web['menu_color']?>;">
    <div class="container">
        ...
        <ul class="navbar-nav me-auto text-center">
            <li class="nav-item">
                <a class="hvr-icon-up nav-link <?php if(@$_GET['page'] == "home"){ echo "active"; } ?> " href="page/home"><i class="fa-solid fa-house hvr-icon" style="color:#56DEC3;"></i> หน้าแรก</a>
            </li>
            <li class="nav-item dropdown">
                <a class="hvr-icon-up nav-link dropdown-toggle <?php if(@$_GET['page'] == "shop" || @$_GET['page'] == "shopaccount"){ echo "active"; } ?>" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
            ...
            <li class="nav-item"> 
                <a class="hvr-icon-up nav-link <?php if(@$_GET['page'] == "game"){ echo "active"; } ?>" href="page/game"><i class="fa-solid fa-dice hvr-icon"></i> เกมสุ่มรางวัล</a>
            </li>
            <li class="nav-item">
                <a class="hvr-icon-up nav-link <?php if(@$_GET['page'] == "topup"){ echo "active"; } ?> " href="page/topup"><i class="fa-regular fa-credit-card hvr-icon" style="color:#FF5AA8;"></i> เติมเงิน</a>
            </li>
            <li class="nav-item">
                <a class="hvr-icon-up nav-link <?php if(@$_GET['page'] == "inventory"){ echo "active"; } ?>" href="page/inventory"><i class="fa-solid fa-box-open hvr-icon" style="color:#949FFF;"></i> คลังเก็บของ</a>
            </li>
        </ul>
        <?php if(isset($_SESSION['username'])): ?>
            <div class="d-flex flex-row-reverse">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a href="page/profile" class="btn btn-dark btn-sm hvr-icon-up"><i class="fa-solid fa-user-tie hvr-icon" style="color:#fff;"></i> <?=$users_username;?> : <i class="fa-solid fa-coins"></i> <span id="pointnow_nav"><?=number_format($users_point,2)?></span> เครดิต</a>
                        <?php if($users_status == $admin_status):?>
                        <a href="page/manage" class="btn btn-info btn-sm hvr-icon-up"><i class="fa-solid fa-code hvr-icon" style="color:#fff;"></i> จัดการหลังบ้าน</a>
                        <?php endif;?>
                        <a class="btn btn-danger btn-sm hvr-icon-forward" onclick="logout()"><i class="fa-solid fa-right-from-bracket hvr-icon"></i> ออกจากระบบ</a>
                    </li>
                </ul>
            </div>
        ...
        <?php else:?>
            <div class="d-flex flex-row-reverse">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="btn btn-primary btn-sm" href="page/login"><i class="fa-solid fa-user-lock" style="color:#fff;"></i> เข้าสู่ระบบ</a>
                        <a class="btn btn-primary btn-sm" href="page/register"><i class="fa-solid fa-address-book" style="color:#fff;"></i> สมัครสมาชิก</a>
                    </li>
                </ul>
            </div>
        <?php endif;?>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <?php
            if(@$_GET['page'] == "login"){
                if(!isset($_SESSION['username'])) { include 'view/view_login.php'; }else{ include 'view/view_home.php'; }
            }else if(@$_GET['page'] == "register"){ 
                if(!isset($_SESSION['username'])) { include 'view/view_register.php'; }else{ include 'view/view_home.php'; }
            }else if(@$_GET['page'] == "topup"){ 
                if(!isset($_SESSION['username'])) { include 'view/view_login.php'; }else{ include 'view/view_topup.php'; }
                ...
                if(!isset($_SESSION['username'])) { include 'view/view_login.php'; }else{ include 'view/view_deposit.php'; }
            }else if(@$_GET['page'] == "profile"){ 
                if(!isset($_SESSION['username'])) { include 'view/view_login.php'; }else{ include 'view/view_profile.php'; }
            }else if(@$_GET['page'] == "inventory"){ 
                if(!isset($_SESSION['username'])) { include 'view/view_login.php'; }else{ include 'view/view_history.php'; }
            }else if(@$_GET['page'] == "game"){ 
                if(!isset($_SESSION['username'])) { include 'view/view_login.php'; }else{ include 'view/view_game.php'; }
            }else if(@$_GET['page'] == "product"){ 
                include 'view/view_product.php';
            }else if(@$_GET['page'] == "manage"){ //admin page
                if(!isset($_SESSION['username'])) { include 'view/view_login.php'; }else{ 
                    if($users_status == $admin_status){ include 'view/admin_manage/admin_home.php'; }else{  include 'view/view_home.php'; }
                }
        ...
        <div class="col-md-12 col-sm-12 mt-4 text-center text-white">
            ...
            <a style="text-decoration: none;color:#fff;" href="page/policy">Privacy Policy</a></p>
