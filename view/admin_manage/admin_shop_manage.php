<div class="col-md-12 col-sm-12 mt-2" data-aos="zoom-in">
    <div class="card mb-3">
        ...
        <div class="card-body p-4">
            ...
            <a class="btn btn-primary mb-2" href="?page=manage&admin=manageshop&t=id">ประเภทไอดีเกม</a>
            <a class="btn btn-primary mb-2" href="?page=manage&admin=manageshop&t=account">ประเภทบัญขี</a>
