...
<div class="col-md-4 col-sm-12 mt-4" data-aos="zoom-in">
    <div class="card crad_tung mb-3 text-white ">
        <div class="card-header"><i class="fa-solid fa-circle-dollar-to-slot" style="color:#C46A00;"></i> Topup -
            เติมเงิน</div>
        <div class="card-body">

            <div class="mb-4 text-center">
                <img src="assets/img/icons/truewallet.png" style="height: 9.9rem;width: 9.9rem; " alt="a"
                    class="card-img-top img-proflie">
            </div>
            <div class="form-group mb-3">
                <label class="col-form-label" for="inputDefault"><i class="fa-solid fa-link"></i> Aungpao - ลิ้งอังเป่า
                    <a href="" data-bs-toggle="modal" data-bs-target="#howtotopup"> วิธีเติมเงินด้วยอังเป่า</a> </label>
                <input type="text" class="form-control" placeholder="https://gift.truemoney.com/campaign/?v=xxxx"
                    id="link_topup">
            </div>
            <div class="form-group mb-3">
                <div class="g-recaptcha d-flex align-items-center justify-content-center" style="margin-top: 15px;"
                    data-sitekey="<?php echo SITE_KEY; ?>"></div>
            </div>

            <div class="form-group mb-3">
                <button onclick="topups()" class="btn btn-primary w-100"><i class="fa-solid fa-circle-check"></i>
...
<div class="col-md-8 col-sm-12 mt-4" data-aos="zoom-in">
    ...
    <div class="card mb-3">
        <div class="card-header"><i class="fa-solid fa-wallet" style="color:#3D9B00;"></i> Topup History -
            ประวัติการเติมเงิน</div>
        <div class="card-body">
            <?php
            $stmt = $connect->prepare("SELECT * FROM tbl_topup WHERE username = ?");
            $stmt->bind_param('s', $users_username);
            $stmt->execute();
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 text-center mt-2">
                        <div class="table-responsive">
                            <table id="tbl_topuphistory" cellspacing="1"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <img src="assets/img/aungpao_truewallet.png" style="height: 100%;width: 100%; " alt="a"
                    class="card-img-top img-proflie">
            </div>
